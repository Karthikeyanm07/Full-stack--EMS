...
import { dummyEmployeeData, DEPARTMENTS } from "../assets/data";
...
const Employees = () => {
	...
	const fetchEmployees = useCallback(async () => {
		try {
			// Build URL if user apply or select particular dept
	...
	// This func - Do if Search bar Value <-> Employee Data Matches. It return that employee we show.
		...
		<div className="animate-fade-in">
			...
			{loading ? (
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
					{filtered.length === 0 ? (
						<p
							className="col-span-full text-center py-16 text-slate-400 bg-white
